        ...
        <div className="prose max-w-none">
          {content ? (
            ...
            <>
              ...
              <p className="text-lg mb-6">
                Tarjoan sparraus- ja konsultaatiopalvelua asiakastyötä tekeville
                ammattilaisille sekä esihenkilöille. Konsultaatio on
                ulkopuolista asiantuntija-apua, jonka tavoitteena on tukea,
                selkeyttää ja vahvistaa työn suuntaa ja laatua.
              </p>

              <h2 className="text-2xl font-semibold mt-8 mb-4">
                Konsultointi voi kohdistua esimerkiksi:
              </h2>
              ...
              <p className="text-lg mb-6">
                Se voi olla kertaluonteinen keskustelu tietystä asiasta tai
                ilmiöstä, tai pidempikestoinen sparraus- ja valmennusprosessi.
              </p>

              <h2 className="text-2xl font-semibold mt-8 mb-4">
                Asiantuntijuusalueitani ovat:
              </h2>
              <ul className="list-disc pl-6 mb-6">
              ...
              <section className="bg-gray-50 p-6 rounded-lg shadow-sm mt-8 mb-6">
                ...
                <p className="text-lg mb-4">
                  Sparrauksen ja konsultaation hinta sovitaan aina tilaajan
                  kanssa niiden sisällön, keston, aihealueen ja mahdollisten
                  matkakulujen perusteella.
                </p>
                ...
                <ul className="list-disc pl-6 mb-4">
                  ...
                  <li>
                    Sparrauskeskustelu, ryhmä (enemmän kuin 7 hlö) — 400 €/60
                    min
                  </li>
                </ul>

                <h3 className="text-xl font-medium mt-4 mb-2">
                  Asiakirjan tai tuotoksen kommentointi
                </h3>
                <ul className="list-disc pl-6 mb-4">
