          ...
          <>
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-700 max-w-2xl mx-auto">
                Tarjoan seksuaalineuvontaa, joka kohtaa sinut avoimesti ja
                arvostavasti missä tahansa elämäntilanteessa. Seksuaalisuus on
                osa ihmisen hyvinvointia ja ihmisenä olemista – yksin tai
                suhteissa.
              </p>
            </div>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-semibold mb-4">
                Neuvonnassa käsitellään esimerkiksi
              </h2>
              ...
              <p className="text-gray-700 mb-6">
                Lähestyn seksuaalineuvontaa lempeästi, luottamuksellisesti ja
                kokonaisvaltaisesti, kunnioittaen yksilöllisyyttäsi ja
                tarpeitasi. Tavoitteena on lisätä itsetuntemusta, hyvinvointia
                ja turvallisuuden tunnetta.
              </p>

              <p className="text-gray-700 mb-6">
                Omia erityisosaamisalueitani ovat seksuaalisuuden ja sukupuolen
                moninaisuus. Erityisesti olen auttanut monia henkilöitä, joilla
                on sukupuolidysforiaa.
              </p>
            </section>

            <section className="bg-gray-50 p-6 rounded-lg shadow-sm mb-12">
              <h2 className="text-2xl font-semibold mb-4">
                Hinnoittelu (seksuaalineuvonta)
              </h2>
              ...
              <h3 className="text-xl font-medium mt-2 mb-2">
                Perheneuvonta (esim. vanhemmat lapsen kanssa)
              </h3>
              <ul className="list-disc pl-6 mb-4 text-gray-700">
